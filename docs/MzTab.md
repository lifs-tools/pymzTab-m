...
**comment** | [**List[Comment]**](Comment.md) | Comment lines can be placed anywhere in an mzTab file. These lines must start with the three-letter code COM and are ignored by most parsers. Empty lines can also occur anywhere in an mzTab file and are ignored.  | [optional] [default to []]
...
mz_tab_instance = MzTab.from_json(json)
# print the JSON string representation of the object
print(MzTab.to_json())

# convert the object into a dict
mz_tab_dict = mz_tab_instance.to_dict()
# create an instance of MzTab from a dict
mz_tab_from_dict = MzTab.from_dict(mz_tab_dict)
```
