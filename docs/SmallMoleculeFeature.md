...
**abundance_assay** | **List[float]** | The feature’s abundance in every assay described in the metadata section MUST be reported. Null or zero values may be reported as appropriate. | [optional] [default to []]
...
small_molecule_feature_instance = SmallMoleculeFeature.from_json(json)
# print the JSON string representation of the object
print(SmallMoleculeFeature.to_json())

# convert the object into a dict
small_molecule_feature_dict = small_molecule_feature_instance.to_dict()
# create an instance of SmallMoleculeFeature from a dict
small_molecule_feature_from_dict = SmallMoleculeFeature.from_dict(small_molecule_feature_dict)
```
