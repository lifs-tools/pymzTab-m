...
class Parameter(BaseModel):
    ...
    cv_label: Optional[StrictStr] = ''
    cv_accession: Optional[StrictStr] = ''
    name: StrictStr
    value: StrictStr
    __properties: ClassVar[List[str]] = ["id", "cv_label", "cv_accession", "name", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "cv_label": obj.get("cv_label") if obj.get("cv_label") is not None else '',
            "cv_accession": obj.get("cv_accession") if obj.get("cv_accession") is not None else '',
            "name": obj.get("name"),
