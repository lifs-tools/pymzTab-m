...
class Comment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prefix", "msg", "line_number"]

    @field_validator('prefix')
    def prefix_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['COM']):
            raise ValueError("must be one of enum values ('COM')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prefix": obj.get("prefix") if obj.get("prefix") is not None else 'COM',
            "msg": obj.get("msg"),
