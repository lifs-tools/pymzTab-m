...
class SampleProcessing(BaseModel):
    ...
    sample_processing: Optional[List[Parameter]] = Field(default=None, description="Parameters specifiying sample processing that was applied within one step.", alias="sampleProcessing")
    __properties: ClassVar[List[str]] = ["id", "sampleProcessing"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "sampleProcessing": [Parameter.from_dict(_item) for _item in obj["sampleProcessing"]] if obj.get("sampleProcessing") is not None else None
        })
        return _obj
