...
class Software(BaseModel):
    ...
    setting: Optional[List[StrictStr]] = Field(default=None, description="A software setting used. This field MAY occur multiple times for a single software. The value of this field is deliberately set as a String, since there currently do not exist cvParams for every possible setting. ")
    __properties: ClassVar[List[str]] = ["id", "parameter", "setting"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "parameter": Parameter.from_dict(obj["parameter"]) if obj.get("parameter") is not None else None,
