...
class CV(BaseModel):
    ...
    label: StrictStr = Field(description="The abbreviated CV label.")
    full_name: StrictStr = Field(description="The full name of this CV, for humans.")
    version: StrictStr = Field(description="The CV version used when the file was generated.")
    uri: StrictStr = Field(description="A URI to the CV definition.")
    __properties: ClassVar[List[str]] = ["id", "label", "full_name", "version", "uri"]
