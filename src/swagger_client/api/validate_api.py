...
class ValidateApi(object):
    ...
    def validate_mz_tab_file(self, mztabfile, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.validate_mz_tab_file_with_http_info(mztabfile, **kwargs)  # noqa: E501
            return data
    ...
    def validate_mz_tab_file_with_http_info(self, mztabfile, **kwargs):  # noqa: E501
        ...
        if ('mztabfile' not in params or
            ...
            raise ValueError("Missing the required parameter `mztabfile` when calling `validate_mz_tab_file`")  # noqa: E501

        if 'max_errors' in params and params['max_errors'] > 500:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_errors` when calling `validate_mz_tab_file`, must be a value less than or equal to `500`")  # noqa: E501
        if 'max_errors' in params and params['max_errors'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `max_errors` when calling `validate_mz_tab_file`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
