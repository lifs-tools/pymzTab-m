...
class Contact(IndexedElement):
    ...
    def __init__(self, name=None, affiliation=None, email=None, **kwargs):  # noqa: E501
        """Contact - a model defined in Swagger"""  # noqa: E501
        super(Contact, self).__init__(element_type="Contact", **kwargs)
        self._name = None
    ...
    def email(self, email):
        ...
        :type: str
        """
        if email is not None and not re.search(r'^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$', email):  # noqa: E501
