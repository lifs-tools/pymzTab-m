...
class SampleProcessing(IndexedElement):
    ...
    def __init__(self, sample_processing=None, **kwargs):  # noqa: E501
        """SampleProcessing - a model defined in Swagger"""  # noqa: E501
        super(SampleProcessing, self).__init__(element_type="SampleProcessing", **kwargs)
    ...
    def to_dict(self):
        ...
        if issubclass(SampleProcessing, dict):
