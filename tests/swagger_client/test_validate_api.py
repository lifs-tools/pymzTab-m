...
from swagger_client import ApiClient, Parameter, Instrument, MzTab, Software, StudyVariable, MsRun, Assay, CV, Database, \
...
class TestValidateApi(unittest.TestCase):
    ...
    def createTestData(self):
        ...
        #sp = swagger_client.models.SampleProcessing(id=1, sample_processing=[spParam])
        ...
        mtd = swagger_client.models.Metadata(
