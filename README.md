...
------------ | ------------- | ------------- | -------------
*ConvertApi* | [**convert_mz_tab_file**](docs/ConvertApi.md#convert_mz_tab_file) | **POST** /convert | 
*ConvertPlainApi* | [**convert_plain_mz_tab_file**](docs/ConvertPlainApi.md#convert_plain_mz_tab_file) | **POST** /convertPlain | 
